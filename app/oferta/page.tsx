        ...
        <section className="relative overflow-hidden py-20">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              >
                Nowoczesna edukacja w przystępnej formie. Wybierz szkolenie i
                wprowadź swoją rodzinę w świat sztucznej inteligencji.
              </motion.p>
            </div>
          </div>
              ...
              {[
                {
                  title: "Nauka z AI",
                  description:
                    "Jak wykorzystać AI do efektywnej nauki i odrabiania lekcji.",
                  icon: BookOpen,
                ...
                },
                {
                  ...
                  description:
                    "Ochrona danych i bezpieczne korzystanie z technologii.",
                  icon: Sparkles,
                ...
                },
                {
                  ...
                  description:
                    "Budowanie marki osobistej i tworzenie contentu z AI.",
                  icon: Award,
                ...
                >
                  <Card className="h-full border-0 bg-white/60 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group overflow-hidden relative">
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${training.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                    />

                    <CardContent className="p-8 flex flex-col h-full relative z-10">
                      <div
                        className={`w-16 h-16 bg-gradient-to-br ${training.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg transform group-hover:scale-110 transition-transform duration-300`}
                      >
                      ...
                      <div className="space-y-6">
                        ...
                        {training.comingSoon ? (
                          <Button
                            disabled
                            className="w-full bg-gray-100 text-gray-400 h-12 text-lg font-medium rounded-xl border border-gray-200 cursor-not-allowed"
                          >
                            Wkrótce
                          </Button>
                        ) : (
            ...
            <div className="max-w-4xl mx-auto bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-8">
                ...
                <p className="text-xl text-indigo-100 max-w-2xl mx-auto">
                  Skontaktuj się z nami, a pomożemy dobrać odpowiednie szkolenie
                  do Twoich potrzeb i poziomu zaawansowania.
                </p>
                <Button
                  asChild
                  size="lg"
