      ...
      <main className="flex-1 pt-20">
        ...
        <section className="relative overflow-hidden bg-slate-900 py-16 lg:py-24">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="relative aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10 group border border-white/10">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-white text-lg font-bold flex items-center gap-2 drop-shadow-md">
                   ...
                   <p className="text-slate-200 text-sm mt-1 drop-shadow-md opacity-90">
